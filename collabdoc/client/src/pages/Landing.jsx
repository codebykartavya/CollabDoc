...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900 dark:bg-[#0a0a0a] dark:text-white overflow-hidden font-sans transition-colors duration-300">
      ...
      {/* Navbar */}
      <nav className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ease-in-out px-6 py-4 flex items-center justify-between ${
        scrolled ? 'bg-white/80 dark:bg-[#0a0a0a]/80 backdrop-blur-xl border-b border-gray-200 dark:border-white/5' : 'bg-transparent border-transparent'
      }`}>
            ...
            <div className="space-y-4 mb-8">
              ...
              <div className="h-3 w-5/6 bg-gray-200 dark:bg-[#2a2a2a] rounded-sm relative transition-colors duration-300">
                <div className="absolute right-1/4 -top-1 w-0.5 h-5 bg-purple-500 animate-pulse">
                  <div className="absolute -top-3 -left-1 bg-purple-500 text-white text-[8px] px-1 py-0.5 rounded font-bold">Rohan</div>
                </div>
              </div>
